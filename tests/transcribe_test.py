...
def test_transcribe_will_parse_multiple_segment_transcription():
    ...
    assert tx_data_groups == [
        TxDataGroup(
            ...
            tx_data=[
                TxData(speaker_tag="<#spk_1>", text="I will now describe the personal interest .", start=1040, end=4575),
                TxData(speaker_tag="<#spk_2>", text="on the thin side <pause> she as long middle of the back link .", start=4575, end=19020),
                TxData(speaker_tag="<#spk_1>", text="brunette white hair it is parted on the left side .", start=19020, end=24650),
            ],
        )
    ]
...
def test_transcribe_will_not_parse_noise_tags():
    ...
    assert tx_data_groups == [
        TxDataGroup(
            ...
            tx_data=[
                TxData(speaker_tag="<#spk_1>", text="no I am not busy with office work I am just <unk> <unk> on LinkedIn . I am just looking for some .", start=11130, end=16983),
    ...
    assert tx_data_groups == [
        TxDataGroup(
            ...
            tx_data=[
                ...
                TxData(speaker_tag="<#spk_2>", text="<ah> you're s- you seem to be so busy with your office work . ? <pause> <um> are you aware ?", start=5045, end=7105),
                TxData(speaker_tag="<#spk_2>", text="on the thin side <pause> she as long middle of the back link .", start=7105, end=19020),
            ],
        )
    ]
    ...
    assert tx_data_groups == [
        TxDataGroup(
            ...
            tx_data=[
                ...
                TxData(speaker_tag="<#spk_3>", text="I am there only on LinkedIn and of course WhatsApp <continued>", start=38966, end=42895),
    ...
    assert tx_data_groups == [
        TxDataGroup(
            ...
            tx_data=[
                ...
                TxData(speaker_tag="<#spk_2>", text="what happened? I see you get injured.", start=8678, end=11553),
                TxData(speaker_tag="<#spk_3>", text="I was hit by a truck fifteen days ago .", start=11553, end=14219),
                TxData(speaker_tag="<#spk_2>", text="oh, it's really terrible. I hope you'll get well soon", start=14219, end=19575),
            ],
        ),
        TxDataGroup(
            file="/audio-efs/Test_04803_MUL_MUL_0002_20220605-192230_0011_solo2-17-V-2.wav",
            tx_data=[TxData(speaker_tag="<#spk_1>", text="with what seemed to be a blue pattern skirt . <hm> she was carrying a tan purse .", start=20560, end=24700)],
        ),
        TxDataGroup(
    ...
    assert tx_data_groups == [
        TxDataGroup(
            ...
            tx_data=[
                ...
                TxData(speaker_tag="<#spk_3>", text="people seem to have forgotten about Signal .", start=14660, end=16569),
...
def test_transcribe_is_aggregated_based_on_filename():
    ...
    assert tx_data_groups == [
        TxDataGroup(
            ...
            tx_data=[
                TxData(speaker_tag="<#spk_1>", text="no I am not busy with office work . I am just <unk> <unk> on LinkedIn .", start=0, end=2100),
        ...
        TxDataGroup(
            ...
            tx_data=[
                ...
                TxData(speaker_tag="<#spk_3>", text="point of time that thing spiked and now I think it mi- it looks like as though it died down .", start=6624, end=13345),
                TxData(speaker_tag="<#spk_2>", text="correct yeah .", start=13345, end=14660),
                TxData(speaker_tag="<#spk_3>", text="people seem to have forgotten about Signal .", start=14660, end=16569),
                TxData(speaker_tag="<#spk_3>", text="Signal .", start=16569, end=17190),
                TxData(speaker_tag="<#spk_2>", text="yeah but I <er> maybe things have", start=17190, end=20695),
